 ...
 if(tokenverify){
  ...
  <div className="relative w-full max-w-[100] h-20 flex items-center justify-between pt-10 mx-auto px-10 shadow-lg shadow-gray-500/40 ">
    <div className="flex items-center">
      ...
      <p className="ml-[-120px] mt-[-30px] font-extrabold text-4xl">Heaven</p>
    </div>
   ...
   { token ?(<Link onClick={handlelogout} to='/'><button
    ...
    <div
      className={`block md:hidden w-full fixed ${!showMenu ? "-top-[410px]" : "top-0"
  ...
  {showMenu && <div className="mobile-nav-overlay" onClick={toggleMobileNav} />}
</header>
